const SHEET_URL = 'https://script.google.com/macros/s/AKfycbybDmxTZ380bwf_6j53OWOb3CZUs0xAcUIQ7O75Ue1OebiE5b0o7QSl3Wi8pDN0fSJA/exec';
...
async function fetchNews() {
    ...
    const storedNews = localStorage.getItem('selectedMemes');
    if (!storedNews) {
...
async function handleReaction(type) {
    ...
    try {
        ...
        if (data.success) {
            ...
            localStorage.setItem('selectedMemes', JSON.stringify(currentNews));
