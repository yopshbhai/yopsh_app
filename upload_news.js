...
const googleSheetUrl = 'https://script.google.com/macros/s/AKfycbzHQtiBt4B1TloH9kWMH3LU-Uyl8ub-w-ysIxymWS8CTrOpPoaoNRebcklUbxupIZRj/exec';
...
document.getElementById('newsForm').addEventListener('submit', async function(e) {
  ...
  try {
    ...
    messageDiv.textContent = 'Failed to submit News. Please try again.';
    messageDiv.classList.add('error');
  } finally {
    loader.style.display = 'none';
  }
